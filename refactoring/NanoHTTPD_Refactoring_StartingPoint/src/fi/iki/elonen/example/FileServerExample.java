...
public class FileServerExample extends NanoHTTPD {
	...
	public Response serveFile(String uri, Properties header, File homeDir, boolean allowDirectoryListing) {
		System.out.println("header for serveFile() :" + header);
	...
	public static void start(String[] args) {
		...
		FileServerExample fileServer = null;
		try {
			fileServer = new FileServerExample(port);
		} catch (IOException ioe) {
			System.err.println("Couldn't start server:\n" + ioe);
			System.exit(-1);
		}
		fileServer.myFileDir = new File("");
